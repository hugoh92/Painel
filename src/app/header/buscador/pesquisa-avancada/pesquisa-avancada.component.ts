...
export class PesquisaAvancadaComponent implements OnInit {
  ...
  apiUrl(val){
    ...
    this._dataService.getData(`https://django-direm.herokuapp.com/api/curso/?query={codigo_curso,nome_da_ies,sigla_da_ies,natureza_juridica,org_academica,municipio,uf,valor_cc,valor_enade,periodo_funcionamento}&format=json&${filter}`).subscribe(
